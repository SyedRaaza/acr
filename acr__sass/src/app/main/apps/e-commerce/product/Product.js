...
function Product(props) {
	...
	const accordianHandleChange = (panel) => (event, isExpanded) => {
	...
	return (
		<FusePageCarded
			...
			contentToolbar={
				...
				>
					<Tab className="h-64" label="Tab 1" />
					<Tab className="h-64" label="Tab 2" />
					<Tab className="h-64" label="Tab 3" />
					<Tab className="h-64" label="tab 4" />
					<Tab className="h-64" label="tab 5" />
				</Tabs>
			}
			content={
				form && (
					<div className="p-16 sm:p-24 max-w-2xl">
						...
						{tabValue === 1 && (
							...
							<div className={classes.root}>
								<Accordion expanded={expanded === 'panel1'} onChange={accordianHandleChange('panel1')}>
									<AccordionSummary
								...
								<Accordion expanded={expanded === 'panel2'} onChange={accordianHandleChange('panel2')}>
									<AccordionSummary
									expandIcon={<ExpandMoreIcon />}
								...
								<Accordion expanded={expanded === 'panel3'} onChange={accordianHandleChange('panel3')}>
									<AccordionSummary
									expandIcon={<ExpandMoreIcon />}
